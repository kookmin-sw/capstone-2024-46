...
const (
	...
	ConversationMessageRoleUnspecified ConversationMessageRole = "unspecified"
	ConversationMessageRoleUser        ConversationMessageRole = "user"
)

// Defines values for CreateChatConversationResponseObjectType.
const (
	CreateChatConversationResponseObjectTypeChatCompletion CreateChatConversationResponseObjectType = "chat_completion"
	CreateChatConversationResponseObjectTypeUnspecified    CreateChatConversationResponseObjectType = "unspecified"
)
...
// CreateChatConversationRequest defines model for CreateChatConversationRequest.
type CreateChatConversationRequest struct {
	// Messages array of messages
	Messages []ConversationMessage `json:"messages"`

	// SystemVersion system version for testing
...
// CreateChatConversationResponse defines model for CreateChatConversationResponse.
type CreateChatConversationResponse struct {
	// CreateTime The Unix timestamp (in seconds) of when the chat completion was created.
	CreateTime time.Time `json:"createTime"`

	// Id A unique identifier for the chat conversation.
	Id string `json:"id"`

	// Message The generated chat conversation message.
	Message ConversationMessage `json:"message"`

	// ObjectType The object type, which is always `chat_completion`.
	ObjectType CreateChatConversationResponseObjectType `json:"objectType"`
...
// CreateChatConversationResponseObjectType The object type, which is always `chat_completion`.
type CreateChatConversationResponseObjectType string
...
// PlaygroundChatServiceCreateChatConversationJSONRequestBody defines body for PlaygroundChatServiceCreateChatConversation for application/json ContentType.
type PlaygroundChatServiceCreateChatConversationJSONRequestBody = CreateChatConversationRequest
